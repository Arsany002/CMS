...
database/
  ...
  migrations/
    ...
    2026_06_11_000001_add_foreign_key_to_users_clinic_id.php
    2026_06_11_000002_add_fulltext_index_to_patients.php
  seeders/
    DatabaseSeeder.php
    RoleSeeder.php
  .gitignore
...
## File: app/Http/Requests/Appointment/AvailableSlotsRequest.php
`````php
<?php
...
## File: app/Http/Requests/Appointment/UpdateAppointmentStatusRequest.php
`````php
<?php
...
## File: app/Jobs/SendAppointmentConfirmation.php
`````php
<?php
...
## File: app/Services/ClinicService.php
`````php
<?php
...
## File: database/migrations/2026_06_11_000001_add_foreign_key_to_users_clinic_id.php
`````php
<?php
...
## File: database/migrations/2026_06_11_000002_add_fulltext_index_to_patients.php
`````php
<?php
